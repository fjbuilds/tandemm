...
const AD_TYPES = [
  ...
  },
  {
    ...
    body: "The classic pay-per-click ads that sit under LSA and above the map. Best for services where LSA doesn't yet cover your trade or postcode, and for driving traffic to a specific landing page.",
    bullets: [
...
const CAPTURE_FEATURES = [
  ...
  },
  {
    ...
    body: "If a call goes to voicemail, the homeowner gets a text from your number within seconds — 'Sorry I missed you, quickest way to get me is here…' — and the callback lands in the same dashboard.",
  },
  {
...
const DASHBOARD_FEATURES = [
  ...
  },
  {
    ...
    body: "New → Quoting → Booked → Dead. One tap to move a lead along. When a lead sits too long, it flags for a chase.",
  },
  {
...
export default function FeaturesPage() {
  return (
    ...
    >
        ...
        <div className="mx-auto max-w-[820px]">
          ...
          <Reveal>
            <p className="mx-auto mt-[22px] max-w-[620px] text-[19px] leading-[1.6] text-[var(--color-ink-muted)]">
              We rebuild your website. We run the Google Ads. We put a widget
              and a tracking number on the site. Every call, form and missed
              call lands in one dashboard, tied back to the ad that brought
              it in.
            </p>
          </Reveal>
          <Reveal>
          ...
          <Reveal>
            <div>
              ...
              <p className="mb-6 text-[16px] leading-[1.6] text-[var(--color-ink-muted)]">
                We run two ad types side by side. LSA at the very top — pay
                only when a homeowner contacts you. Google Ads underneath —
                pay per click, best for the searches LSA does not cover.
                Both landing on pages built for one job: a booked enquiry.
              </p>
        ...
        <div className="mx-auto max-w-[1160px]">
          <Reveal className="mb-12 text-center">
            ...
            <p className="mx-auto mt-3 max-w-[600px] text-[15px] leading-[1.6] text-[var(--color-ink-muted)]">
              Most trades do not know they can run both. We do. And we shift
              spend between them based on which is paying back for the jobs
              you want more of.
            </p>
          </Reveal>
          ...
          <Reveal>
            <div className="mx-auto mt-8 max-w-[720px] rounded-[var(--radius-lg)] border border-[var(--color-hairline)] bg-[var(--color-surface-muted)] px-6 py-4 text-center text-[14.5px] leading-[1.55] text-[var(--color-ink-muted)]">
              ...
              not when they click. That is why we lead with it wherever your
              trade and area qualify.
            </div>
          </Reveal>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-[1160px] px-6 py-20">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <Reveal>
            <div>
              <div className="mb-2 text-xs font-bold uppercase tracking-[0.08em] text-[var(--color-accent)]">
                Website, rebuilt free
              </div>
              <h2 className="mb-4 font-[family-name:var(--font-display)] text-[clamp(26px,3.4vw,36px)] font-bold leading-[1.12] tracking-[-0.02em]">
                A site built to turn visitors into booked jobs, not to win awards.
              </h2>
              <p className="mb-6 text-[16px] leading-[1.6] text-[var(--color-ink-muted)]">
                We rebuild your website as part of the sign-up — no upfront
                fee. Fast, plain, mobile-first. Every page has one job:
                get a homeowner into the widget or onto the phone.
              </p>
      ...
      {/* ── LEAD CAPTURE (WIDGET + CALL TRACKING) ── */}
      <section className="mx-auto max-w-[1160px] px-6 py-20">
        <Reveal className="mb-12 text-center">
          <div className="mb-2 text-xs font-bold uppercase tracking-[0.08em] text-[var(--color-accent)]">
            Lead capture
      ...
      <section className="bg-[var(--color-canvas-deep)] px-6 py-20">
        <div className="mx-auto max-w-[1160px]">
          <Reveal className="mb-10 text-center">
            ...
            <p className="mx-auto mt-3 max-w-[600px] text-[15px] leading-[1.6] text-[var(--color-ink-muted)]">
              Everything below is included in the one monthly fee. No
              upsells, no add-ons.
            </p>
          </Reveal>
              ...
              {[
                ...
                >
                  ...
                  <div className="text-left sm:text-right">
                    <span className="inline-flex items-center gap-1.5 rounded-full bg-[var(--color-success-soft)] px-2.5 py-[3px] text-[11px] font-bold uppercase tracking-[0.06em] text-[var(--color-success)]">
                      Included
                    </span>
                  </div>
                </div>
...
/* ─────────────────────────────────────────────────────────── */
/*  Google SERP mock — 'top of Google' visual                  */
/* ─────────────────────────────────────────────────────────── */
      ...
      <div className="rounded-[16px] border border-[var(--color-hairline)] bg-white shadow-[var(--shadow-2)]">
        ...
        <div className="flex items-center gap-2 border-b border-[var(--color-hairline-soft)] px-4 py-3">
          ...
          <div className="ml-3 flex flex-1 items-center gap-2 rounded-full bg-[#f1f3f4] px-3 py-1.5">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#5f6368" strokeWidth="2" aria-hidden="true">
        ...
        <div className="px-5 py-4">
          ...
          <div className="rounded-[10px] border-2 border-[var(--color-accent)] bg-[#fff8f2] p-3">
            <div className="mb-2 flex items-center justify-between gap-3">
              ...
              <span className="flex items-center gap-1 rounded-sm bg-[#0f9d58] px-1.5 py-[1px] text-[9px] font-bold text-white">
                ✓ Google Guaranteed
              </span>
            </div>
...
/* ─────────────────────────────────────────────────────────── */
/*  Website mock — realistic homepage in a laptop frame        */
/* ─────────────────────────────────────────────────────────── */
        ...
        <div className="overflow-hidden rounded-t-[8px] bg-white">
          ...
          <div className="bg-gradient-to-br from-[#f8f4ec] to-[#f0eae0] px-5 py-6">
            <div className="grid grid-cols-[1.4fr_1fr] gap-4">
              <div>
                <div className="mb-1 inline-flex items-center gap-1 rounded-full bg-white px-2 py-[2px] text-[8px] font-semibold text-[var(--color-accent-hover)]">
                  ★ Rated 4.9 · Google
                </div>
...
/* ─────────────────────────────────────────────────────────── */
/*  Dashboard mock — laptop + phone side by side               */
/* ─────────────────────────────────────────────────────────── */
...
function DashboardMock() {
  const rows = [
    ...
    { name: "J. Reid", area: "SW15", src: "Missed call", job: "Callback requested", val: "—", stage: "New", stageTone: "primary" },
...
function MissedCallFlow() {
  const steps = [
    { t: "09:42", label: "Homeowner calls", desc: "You're on the tools." },
  ...
  return (
    <div className="rounded-[var(--radius-xl)] border border-[var(--color-hairline)] bg-[var(--color-surface)] p-7 shadow-[var(--shadow-1)]">
      <div className="mb-1 text-xs font-bold uppercase tracking-[0.06em] text-[var(--color-accent)]">
      ...
      <p className="mb-6 text-[14.5px] leading-[1.55] text-[var(--color-ink-muted)]">
        You can't answer every call. The system does the follow-up for you.
      </p>
