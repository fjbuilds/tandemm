...
**Key Effects:** display: grid, gap: 2rem, 12-16 column grid, subtle hover (200-250ms), sharp shadows if any, clear type hierarchy, fast loading

### Page Pattern

**Pattern Name:** Trust & Authority + Conversion (Home), Feature-Rich Showcase (Product)

- **Conversion Strategy:** Credibility-first — mission/positioning, proof (logos, stats, case studies), solution overview, single clear CTA path. No mega menu / audience-splitting.
- **CTA Placement:** "Book a demo" (Primary) + "Log in" (Secondary, header only)
- **Home Section Order:** 1. Hero (value prop for sales teams), 2. Client logos / trust bar, 3. Feature grid (3-4 cards), 4. How it works, 5. Testimonial, 6. Pricing teaser, 7. Final CTA
- **Product Section Order:** Hero (value prop) → Feature grid/cards (4-6) → Use cases/benefits → Social proof → CTA
